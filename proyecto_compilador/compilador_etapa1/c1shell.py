...
def term():
    ...
    sign = 1
    factor()
    while token.category in [TIMES, POWER, DIV]:
        advance()
        sign = 1
        factor()
...
'''''
cd "E:\Ing ciencia de datos\Cuarto cuatri\Paradigmas de programacion\CLASE 7\proyecto_compilador\compilador_etapa1"
